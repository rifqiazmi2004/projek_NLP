...
def predict(processed_text):
    ...
    response_scoring = requests.post(
        'https://us-south.ml.cloud.ibm.com/ml/v4/deployments/9ed9ddc5-34a3-4c4f-be75-febd5660bc0a/predictions?version=2021-05-01',
...
def text_preprocessing(comment):
    loaded_model = tf.keras.models.load_model("text_vectorization_layer2.keras")
